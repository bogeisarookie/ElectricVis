const data = [
  ...
  function mockData() {
     ...
     * 中间部分
     */
    mock(center_righttop,center_leftbootom,30)
    mock(bottom_righttop,bottom_leftbootom,13)
    mock(right_righttop,right_leftbottom,10)
    mock(left_righttop,left_leftbottom,10)
    mock(top_righttop,top_leftbottom,10)
    mock(right_bottom_righttop,right_bottom_leftbottom,9)
    mock(left_bottom_righttop,left_bottom_leftbottom,7)
    mock(left_top_righttop,left_top_leftbottom,10)
    return points
